...
import { 
  LayoutDashboard, Home, Box, ArrowLeftRight, Settings, Package, ListTodo, User, ShoppingCart, Tags
...
const menuItems = [
  ...
  { label: 'Definitions Hub', icon: Tags, path: '/dashboard/user/manage-definitions', roles: ['hod', 'manager'] },
